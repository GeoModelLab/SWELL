...
#'
#' @param SWELLparameters A data frame containing the initial SWELL model parameters.
#'   The following columns are required:
#'   \describe{
#'     \item{\code{species}}{(character) The species or vegetation type (e.g., "beech").}
#'     \item{\code{class}}{(character) The parameter class (e.g., "parDormancy").}
#'     \item{\code{parameter}}{(character) The specific parameter name.}
#'     \item{\code{min}}{(numeric) Minimum allowable value for the parameter.}
#'     \item{\code{max}}{(numeric) Maximum allowable value for the parameter.}
#'     \item{\code{value}}{(numeric) Initial value of the parameter.}
#'     \item{\code{is_calibrated}}{(logical) Indicates if the parameter is subject to calibration (\code{TRUE} or \code{FALSE}).}
#'   }
#'
